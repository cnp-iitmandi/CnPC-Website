  ...
  return (
    <>
      <div>
        ...
        <div className="container">
          <h3 className="faculty-head">From the Faculty Advisor, Placement</h3>
        ...
        {/*<div className="light container cont">
          <hr className="left-light" />
          <h3 className="homeHead-light">Another FA's Address</h3>
          <hr className="right-light" />
        </div>*/}
        <div className="container">
          ...
          <div className="about container-fluid row item">
            <p className="bhashan2 col-lg-8 col-md-8 col-sm-12 backG">
              ...
              extracurricular activities and leadership roles, earning accolades and honing diverse skills. The 
